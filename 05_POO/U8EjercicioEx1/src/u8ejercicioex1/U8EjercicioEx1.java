...
public class U8EjercicioEx1 {
    ...
    public static void main(String[] args) {
        ...
        Raices raiz1 = new Raices(1,3,2);
        Raices raiz2 = new Raices(1,-6,9);
        Raices raiz3 = new Raices(1,1,1);
        servicio.calcular(raiz1);
        servicio.calcular(raiz2);
        servicio.calcular(raiz3);
    }
